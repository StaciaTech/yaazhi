            ...
            <div className="flex flex-col gap-4">
              {["About Us", "Gallery", "News & Press", "Testimonials"].map((link) => (
                <Link
                  ...
                  className="text-sm opacity-70 hover:opacity-100 hover:translate-x-2 transition-all duration-300 inline-block"
                >
                  {link}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                className="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-all duration-300 group"
              >
              ...
              <div className="flex items-center gap-4 mt-4">
                <a
                  ...
                  className="p-3 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/25 hover:scale-110 transition-all duration-300"
                >
