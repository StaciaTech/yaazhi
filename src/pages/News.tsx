...
const pastHighlights = ["Chennai Music Season 2024 – Featured Artist", "SVCE Annual Day Performance", "Corporate Shows for Fortune 500 Companies", "Wedding Season Tour 2024"];
const mediaMentions = [{
  ...
  return <Layout>
      ...
      <section className="section-padding pt-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {upcomingShows.map((show, index) => <div key={index} className="card-yaazhi p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 opacity-0 animate-fade-up" style={{
      ...
      <section className="section-padding bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {pastHighlights.map((highlight, index) => <div key={index} className="flex items-center gap-4 p-4 rounded-xl bg-card shadow-soft">
      ...
      <section className="section-padding">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {mediaMentions.map((mention, index) => <div key={index} className="group card-yaazhi p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 cursor-pointer opacity-0 animate-fade-up" style={{
